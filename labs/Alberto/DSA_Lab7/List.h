...
public:
	...
	*/
	...
	sobre la lista que permite recorrer la lista e
	incluso alterar el valor de sus elementos.
	*/
	...
	protected:
		...
		ReverseIterator() : _act(NULL) {}
		ReverseIterator(Nodo *act) : _act(act) {}
